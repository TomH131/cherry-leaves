...
def page_project_hypothesis_body():
    ...
    st.warning(
        ...
        "As a result, we can see that the business requirements set by the client "
        "at the outset have been met. We conducted a study to visually distinguish "
        "healthy cherry leaves from those affected by powdery mildew, enabling the "
        "client to accurately predict the condition of cherry leaves from images.\n\n"
    )